...
<!-- Theme style -->
<link rel="stylesheet" href="{{ url('public/backend/dist/css/AdminLTE-rtl.min.css') }}">
...
<link rel="stylesheet" href="{{ url('public/backend/style-background.css') }}">
