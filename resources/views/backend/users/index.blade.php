            ...
            <table class="table table-bordered table-striped {{ count($users) > 0 ? 'datatable' : '' }} @can('user_delete') dt-select @endcan">
                <thead>
                    <tr>
                        ...
                        <th style="text-align:right;">@lang('quickadmin.users.fields.name')</th>
                        <th style="text-align:right;">@lang('quickadmin.users.fields.email')</th>
                        <th style="text-align:right;">@lang('quickadmin.users.fields.role')</th>
                                                <th>&nbsp;</th>
