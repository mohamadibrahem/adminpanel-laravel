...
return [
	...
	'projects' => [
		...
		'fields' => [
			'title_ar' => 'العنوان عربي',
			'title_en' => 'العنوان انكليزي',
			'description_ar' => 'الوصف انكليزي',
			'description_en' => 'الوصف عربي',
			'link' => 'الرابط',
			'main_image' => 'الصورة الرئيسية',
			'control_itmes' => 'التحكم في العنصر',
		],
	],
	'controller' => [
		'fields' => [
			...
			'destroy' => 'تم النقل الى سلة المهملات',
			'restore' => 'تمت الاستعادة بنجاح',
			'delete' => 'تم الحذف نهائياً',
	...
	'qa_all' => 'الكل',
	'qa_trash' => 'سلة المحذوفات',
	'qa_view' => 'عرض',
	'qa_update' => 'تحديث',
	'qa_list' => 'قائمة',
	'qa_no_entries_in_table' => 'لا توجد بيانات!',
	'qa_custom_controller_index' => 'Custom controller index.',
	'qa_logout' => 'تسجيل خروج',
	'qa_add_new' => 'إضافة جديد',
	'qa_are_you_sure' => 'هل تريد ذلك?',
	'qa_back_to_list' => 'العودة الى القائمة',
	'qa_dashboard' => 'لوحة التحكم',
	'qa_delete' => 'نقل الى سلة المحذوفات',
	...
	'qa_administrator_can_create_other_users' => 'المسؤول (يستطيع انشاء مستخدمين اخرين)',
	'qa_simple_user' => 'مستخدم عادي',
	'qa_title' => 'العنوان',
	'qa_roles' => 'الادوار',
	'qa_role' => 'دور',
	'qa_user_management' => 'إدارة المستخدمين',
	'qa_users' => 'المستخدمين',
	'qa_user' => 'مستخدم',
	'qa_name' => 'الاسم',
